  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
      <main className="flex-1 p-6">
        <h1>Plan operativo institucinal - POI</h1>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card className="h-full w-full max-w-2xl">
            <CardHeader>
              <CardTitle>Bar Chart</CardTitle>
              <CardDescription>
                A bar chart showing total sales for the last 6 months.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="h-full w-full max-w-2xl">
            <CardHeader>
              ...
              <CardDescription>
                A pie chart showing sales distribution across different regions.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="h-full w-full max-w-2xl">
            <CardHeader>
              ...
              <CardDescription>
                A list of tasks to be completed this week.
              </CardDescription>
            </CardHeader>
            <CardContent>
